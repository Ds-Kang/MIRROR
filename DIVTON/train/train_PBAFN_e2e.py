...
if not opt.load_pretrain:
  ...
  load_checkpoint_parallel(warp_model, f"checkpoints/{opt.name}/PBAFN_warp_epoch_{opt.load_pretrain}.pth")
  load_checkpoint_parallel(gen_model, f"checkpoints/{opt.name}/PBAFN_gen_epoch_{opt.load_pretrain}.pth")
